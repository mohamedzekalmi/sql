...
* Catherine marron f
*/
INSERT INTO `user` (`nom`, `color_eyes`,`gender`) 
VALUES ('Vera', 'marron', 'f'), ('Hafida','marron','f'), ('Kylian','marron','h'), ('Priscille','marron','f'),('Pauline','marron','f'),('Ilyes','marron','h'),('Balamini','marron','h'),('Kevin','vert','h'),('Mohamed','marron','h'),('Lamia','marron','f'),('Catherine','marron','f');
...
* 'flanbotti', 'caramel'
*/
INSERT INTO `candy` (`nom`, `flavor`) 
VALUES ('dragibus', 'cola'), ('tagada', 'fraise'), ('bams', 'banane'), ('rotella', 'reglisse'), ('floppys', 'sucre'), ('rainbollows', 'marshmallow'), ('bigharri', 'cerise'), ('oursor', 'fruits'), ('croco', 'fruits'), ('oeufoplat', 'guimauve'), ('flanbotti', 'caramel');
